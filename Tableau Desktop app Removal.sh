...
########################################################################
# This script removes the Tableau Desktop 2021.3 app and associated    #
# files and    	                                                       #
...
# Variables
appName="Tableau Desktop 2021.3"
...
ScriptLogging "Stopping ${appName} open proccesses"
quitApp "Tableau Desktop 2021.3"
...
rm -rf "/Library/Preferences/com.tableau.Tableau-2021.3.plist" 2> /dev/null



# Stopping any stubborn processes
quitApp "Tableau Desktop 2021.3"

ScriptLogging "The removal process of Tableau Desktop 2021.3 has been completed "
